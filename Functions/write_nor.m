...
function string=write_line(datas,format)
    ...
    format_type7='%s';
    string_type7=[' STAT SP IPHASW D HRMM SECON CODA AMPLIT PERI AZIMU VELO AIN AR TRES W  DIS CAZ7'];
    ...
    switch format
        ...
        case 'I'
            string=sprintf('%80s',' ');
            if length(datas.ID) > 14
                ID_str    = datestr(datas.ID,'YYYYmmddHHMMSS');
            else
                ID_str    = datas.ID;
            end
            string(58:74) = sprintf('ID:%14s',ID_str); 
            string(80)    = 'I';
        ...
        case 4
            ...
            string(7)     = sprintf('%1.1s',datas.instrument);
