...
function [Main,flag]=readmain(file)
    ...
    %%% Parameters
    num_fields_pick = 5;   % number of fields that should be given in the station line
    %num_fields_amp=3;    % I am almost sure this is deprecated !!!
    ...
    for i=1:length(cell_stat)
        ...
        if length(str_array)==num_fields_pick
            ...
            SPEC.Kurto_F       = Main.(str_array{4});
            SPEC.Kurto_W       = Main.(str_array{5});
