function EVENT=read_nor(file,savefilename)
    ...
    if nargin==0
        ...
        LINE=cell2struct(cell(21,1),{'station','instrument','component','quality',...
                'phase',...
                'weight',...
                'firstmotion',...
...
function LINE=read_line(line,format)
    ...
    switch format
        ...
        case 4
            ...
            C_char={station,instrument,component,quality,phase,firstmotion};
            for i=1:length(C_char)
                if isempty(C_char{i}) | C_char{i}(1)==' ' 
                    C_char{i}=[];
                end
            end
            [station,instrument,component,quality,phase,firstmotion]=C_char{:};
            
            %%% Make the structure
            LINE=cell2struct({station,instrument,component,quality,phase,...
                C_num{1},firstmotion,C_num{2:end}},{'station','instrument','component','quality',...
                'phase',...
                'weight',...
                'firstmotion',...
                'hour','min','sec','coda','amplitude',...
